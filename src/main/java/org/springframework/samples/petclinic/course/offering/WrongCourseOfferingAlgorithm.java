...
public class WrongCourseOfferingAlgorithm implements CourseOfferingAlgorithm{

    // This implementation select courses that are more than half full! (should be the opposite)
    @Override
