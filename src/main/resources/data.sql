...
INSERT INTO types(id,name)  VALUES (8, 'tortuga');
INSERT INTO types(id,name)  VALUES (9, 'raccoon');
INSERT INTO types(id,name)  VALUES (10, 'mapuche');
INSERT INTO types(id,name)  VALUES (11, 'wolf');
INSERT INTO types(id,name)  VALUES (12, 'fox');
...
INSERT INTO Course(id, name, description, max_attendants, price, vet_id) 
        VALUES  (1,'Martial Arts for Turtles','Intended for Vets that do not mind to attend a course in the NY sewage system',4,500.00,1),
                (2,'Raccoon Revival','Intended for Vets of the galaxy that wants to save a friend',8,1000.00,2),
                (3,'How to Patrol','Intended for Vets that wants to know how dogs can patrol',10,200.00,3),
                (4,'Dummy course','Intended for Dummy Vets that pretend to teach a course',0,10000.00,4),
                (5,'Pet Revival','Intended for Vets that wants to save a pet',8,500.00,2),
                (6,'Raccoon shot accuracy','Intended for Vets of the galaxy that wants to learn hot to teach a raccoon to have more shot accuracy',8,400.00,2),
                (7,'Training Olimpic Turtles','Intended for Vets that want to know how to increase speed of turtles',10,1000.00,1),
                (8,'Armor-plate for Turtles','Intended for Vets that want to know how to increase armors of turtles shell',10,1000.00,1),
                (9,'How to paint paws','Intended for Vets that wants to know how `to paints pets paws',10,200.00,3);


INSERT INTO course_regarded_pet_types(courses_id,regarded_pet_types_id) VALUES (1,7),(1,8),(2,9),(2,10),(3,2),(3,11),(3,12),(3,7),(3,8),(4,1),(5,1),(5,2),(5,3),(5,4),(5,5),(5,6),(5,7),(5,8),(6,9),(6,10),(7,7),(7,8),(8,7),(8,8),(9,7),(9,8),(9,11);

INSERT INTO course_attendance(id, registration_date,grade,attendant_id,course_id) VALUES (1,'2023-01-05',5,5,1);
INSERT INTO course_attendance(id, registration_date,grade,attendant_id,course_id) VALUES (2,'2023-12-18',null,3,2);


INSERT INTO course_payment(id, payment_date, amount) VALUES (1, '2023-01-06', 150.0),(2, '2023-01-10', 150.0),(3, '2023-12-19', 50.0);
INSERT INTO course_attendance_payments(course_attendance_id, payments_id) VALUES (1,1),(1,2),(2,3);
